...
def create_dataloader(path, imgsz, batch_size, stride, single_cls=False, hyp=None, augment=False, cache=False, pad=0.0,
                      rect=False, rank=-1, workers=8, image_weights=False, quad=False, prefix='', shuffle=False, ar_thr=100):
    if rect and shuffle:
...
class LoadImagesAndLabels(Dataset):
    ...
    def __init__(self, path, img_size=640, batch_size=16, augment=False, hyp=None, rect=False, image_weights=False,
                 cache_images=False, single_cls=False, stride=32, pad=0.0, prefix='',ar_thr=100):
        self.img_size = img_size
...
def load_mosaic(self, index):
    ...
    img4, labels4 = random_perspective(img4, labels4, segments4,
                                       ...
                                       border=self.mosaic_border, ar_thr=self.ar_thr)  # border to remove
...
def extract_boxes(path='../datasets/coco128'):  # from utils.datasets import *; extract_boxes()
    # Convert detection dataset into topformer dataset, with one directory per class
