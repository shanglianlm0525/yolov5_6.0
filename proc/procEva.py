...
repeat_list = []
def moveValidData():
    root_path = '/home/lmin/data/collections/eva'
...
lbls = {'evapinjie':0, 'evaqueshi':1 }

def transXML2Yolo():
    lbl_num = [0] * len(lbls)
    hw_ratios = [[0] for _ in lbls]

    rootpath = '/home/lmin/data/collections/eva'
...
os.system('cp -r /home/lmin/data/collections/eva/labels/train2017/* /home/lmin/data/collections/eva/labels/val2017/')
os.system('cp -r /home/lmin/data/collections/eva/images/train2017/* /home/lmin/data/collections/eva/images/val2017/')